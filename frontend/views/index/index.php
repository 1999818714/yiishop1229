...
<div class="colligate w1210 bc mt10">
    ...
    <div class="slide fl">
        <div class="area">
            <div class="slide_items">
                <ul>
                    <li style="opacity: 1; display: none;"><a href=""><img src="images/index_slide1.jpg" alt=""></a></li>
                    <li style="opacity: 1; display: none;"><a href=""><img src="images/index_slide2.jpg" alt=""></a></li>
                    <li style="opacity: 1; display: none;"><a href=""><img src="images/index_slide3.jpg" alt=""></a></li>
                    <li style="opacity: 1; display: none;"><a href=""><img src="images/index_slide4.jpg" alt=""></a></li>
                    <li style="opacity: 1; display: list-item;"><a href=""><img src="images/index_slide5.jpg" alt=""></a></li>
                    <li style="opacity: 1; display: none;"><a href=""><img src="images/index_slide6.jpg" alt=""></a></li>
                </ul>
            </div>
    ...
    <div class="coll_right fl ml10">
        ...
        <div class="service mt10">
            <h2>
                <span class="title1"><a href="">话费</a></span>
                <span class="on"><a href="">旅行</a></span>
                <span class=""><a href="">彩票</a></span>
                <span class="title4"><a href="">游戏</a></span>
            </h2>
            <div class="service_wrap">
                <!-- 话费 start -->
                <div class="fare" style="display: none;">
                    <form action="">
                        <ul>
                            <li>
                                <label for="">手机号：</label>
                ...
                <!-- 旅行 start -->
                <div class="travel none" style="display: block;">
                    <ul>
                        <li>
                ...
                <!-- 彩票 start -->
                <div class="lottery none" style="display: none;">
...
<div class="guide w1210 bc mt15">
    ...
    <div class="guide_content fl">
        <h2>
            ...
            <span class="">热卖商品</span>
            <span class="">精品推荐</span>
        </h2>

        <div class="guide_wrap">
            <!-- 疯狂抢购 start-->
            <div class="crazy" style="display: block;">
                <ul>
                    <li>
                        <dl>
            ...
            <!-- 热卖商品 start -->
            <div class="hot none" style="display: none;">
                <ul>
                    <li>
                        <dl>
            ...
            <!-- 推荐商品 atart -->
            <div class="recommend none" style="display: none;">
                <ul>
                    <li>
                        <dl>
